...
import { Package, Info, CheckCircle2, PlayCircle, ShieldCheck } from 'lucide-react';
...
function KitPage() {
  ...
  return (
    <div className="max-w-md mx-auto px-6 pt-16 pb-24 animate-in fade-in duration-700 space-y-10">
      ...
      <section className="bg-slate-900 rounded-[2.5rem] p-8 text-white space-y-4 shadow-xl shadow-purple-200">
