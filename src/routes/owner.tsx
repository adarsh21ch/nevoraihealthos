          ...
          <div className="p-8 space-y-10 flex flex-col h-full">
            <div className="flex items-center gap-4 px-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Coach Portal</span>
                </div>
            </div>
            
            <nav className="flex-1 space-y-2 overflow-y-auto pr-2 custom-scrollbar">
                <NavItem icon={LayoutDashboard} label="Overview" to="/owner" />
                <NavItem icon={Key} label="Access Codes" to="/owner/access-codes" />
            </nav>
