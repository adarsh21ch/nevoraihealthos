    ...
    <div className="min-h-screen bg-[#FCFBF8] text-[#0F172A] flex font-sans">
      ...
      <aside className="w-64 border-r border-slate-200 bg-white flex flex-col shrink-0">
        <div className="p-6 flex-1 flex flex-col">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
               ...
               <span className="block text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">Platform</span>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-slate-100 space-y-1">
          <Button 
            variant="ghost" 
            className="w-full justify-start text-slate-400 hover:text-slate-900 hover:bg-slate-50 transition-all h-10 px-3 rounded-xl"
            onClick={() => navigate({ to: "/dashboard/settings" })}
          >
            <Settings className="mr-3 h-4 w-4" />
            <span className="font-bold tracking-tight text-xs uppercase tracking-widest">Settings</span>
          </Button>
          <Button 
            variant="ghost" 
