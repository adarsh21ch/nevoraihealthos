...
DROP POLICY IF EXISTS "Admins can select all rows" ON public.access_codes;
DROP POLICY IF EXISTS "Admins can insert all rows" ON public.access_codes;
DROP POLICY IF EXISTS "Admins can delete all rows" ON public.access_codes;
